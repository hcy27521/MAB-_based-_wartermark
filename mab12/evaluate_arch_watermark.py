...
def main_evaluate(cfg):
    ...
    # -------------------------------------------------------------------------------------
    ARCHITECTURES = [
        # Operator_based / Separate_path / Untargeted 示例 (根据您提供的代码片段)
        {
            "Name": "Op_Sep_Untargeted", 
            "WGT_PATH": "checkpoints/op_sep_untargeted/resnet18_best.pth",
            "MODEL_CLASS": OS_Untargeted, 
            "TARGET_LABEL": None # Untargeted, 暂时不计算 WSR
        },
        # Constant_based / Interleaved / Targeted 示例
        {
            "Name": "Const_Int_Targeted", 
            "WGT_PATH": "checkpoints/const_int_targeted/resnet18_best.pth",
            "MODEL_CLASS": BaseBackdoorModel, # 替换为实际类名
            "TARGET_LABEL": 3 
        },
        # ... 补全所有 12 个架构 ...
    ]
