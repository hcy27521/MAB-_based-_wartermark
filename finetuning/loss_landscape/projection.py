...
def project_trajectory(dir_file, w, s, dataset, model_name, model_files,
    ...
    for model_file in model_files:
        net2 = model_loader.load(model_name, model_file)
        if dir_type == 'weights':
...
def setup_PCA_directions(args, model_files, w, s):
    ...
    folder_name = args.model_folder + f'/PCA_{args.prefix}'
    # if args.ignore:
    ...
    matrix = []
    for model_file in model_files:
        net2 = model_loader.load(args.model, model_file)
